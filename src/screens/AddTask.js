...
export default function AddTask(props){
    ...
    const formattedDate = moment(date).format('ddd, D [de] MMM [de] YYYY')
    ...
    return(
        <Modal transparent={true} visible={props.isVisible} onRequestClose={props.onCancel} animationType="slide">
            ...
            <View style={styles.container}>
                ...
                <TextInput style={styles.input} placeholder="Informe a descrição" onChangeText={setDesc} value={desc}/>
